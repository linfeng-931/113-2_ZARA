      ...
      <div className="w-full">
        ...
        <div className="mt-25">
          {cartItems.length === 0 ? (
            ...
            <div className="hidden md:grid grid-cols-7 gap-15 items-center justify-center mb-15">
        ...
        <div className="sm md:hidden">
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item) => (
              <div
                key={item.id}
                className="flex gap-5 items-center justify-center mb-15"
              >
                <Link to={`/products/id/${item.id}`}>
                ...
                <div className="content">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div
                      className="flex justify-center hover:opacity-50 duration-[.2s]"
                      onClick={() => dispatch(removeCartItems(item.id))}
                    >
                      <X className="h-4" />
                    </div>

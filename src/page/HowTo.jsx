  ...
  return (
    <div>
      ...
      <div className="grid grid-rows-1 grid-cols-8  lg:gap-4 lg:grid-rows-1 lg:grid-cols-12 mt-8">
        <ul className="hidden lg:flex lg:flex-col text-left lg:gap-4 lg:col-start-2 lg:col-span-1 text-sm">
          <li className="mb-6 font-bold">換貨、退貨和退款</li>
          <li>
            <a href="#1">如何退貨</a>
          </li>
          <li>
        ...
        <div className="flex flex-col text-left col-start-2 col-span-6 lg:col-start-4 lg:col-span-8 gap-2 lg:max-w-[80%]">
          <div>
            <h1 className="mb-4 font-semibold" id="1">
              如何退貨
            </h1>
            ...
            <div className="flex flex-col gap-4 text-sm">
              ...
              >
                ...
                <div className="collapse-content text-sm leading-8">
                  ...
                  Zara 商店辦理退貨。
                  <br />■
                  如果您購買時使用了線上付款方式，您可以在店內退貨，或者是透過
                  Zara 官網或 APP 申請退貨。
                </div>
              </div>
            </div>
